...
##fix: add
from cell_segmentation.datasets.pannuke_like_instance import PanNukeDataset_mod
...
def select_dataset(
    ...
    elif dataset_name.lower() == "pannuke_like_instance":
